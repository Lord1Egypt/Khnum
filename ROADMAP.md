...
- [x] gh-pages landing site (same pattern as KemetCore's). **LIVE at
      https://lord1egypt.github.io/Khnum/** (verified HTTP 200, status
      "built") — activation confirmed with Mohamed's explicit go-ahead
      2026-07-14.
