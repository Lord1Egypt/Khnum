...
- [x] `docs/CHARACTERIZATION.md`: area/timing tables per size from ORFS reports,
...
- [ ] gh-pages landing site (same pattern as KemetCore's). Content pushed to the
      `gh-pages` branch; **activating GitHub Pages itself needs Mohamed's
      explicit go-ahead** (a public-publish action, deliberately not done
      automatically) — see STATUS.md.
